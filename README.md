...
*   **Sugestão de Ajuste de Cadência:** O parâmetro de falhas vem configurado por padrão em uma taxa baixa (FAILURE_RATE = 0.2). Para testes mais severos de estresse na interface, recomenda-se elevar a probabilidade de falha para 0.8.
    

🏗️ Decisões Técnicas Relevantes
--------------------------------

1.  **Adotação do Luxon para Gestão de Datas no Front:**
...
2.  **Correção de Timezone e Regra de Intervalo de Datas no BFF:**
    
    *   Ajuste do filtro de datas para cobrir desde o primeiro segundo do dia inicial (00:00:00.000) até o último milissegundo do dia final (23:59:59.999).
        
    *   Normalização dos horários para o fuso horário local, eliminando a regressão de data na interface provocada pela conversão UTC.
        
3.  **Arquitetura Reativa no Frontend:**
...
4.  **Trabalho de UX e Coleta de Feedbacks:**
